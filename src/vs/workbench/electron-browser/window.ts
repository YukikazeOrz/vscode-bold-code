			...
			this.notificationService.prompt(
				...
				[{
					...
					run: () => {
						...
						const stableURL = 'https://github.com/YukikazeOrz/vscode-bold-code/releases/latest';
						const insidersURL = 'https://github.com/YukikazeOrz/vscode-bold-code-insiders/releases/latest';
